...
if (isset($_POST['save'])) {
    ...
    $save = "INSERT INTO `user`(`username`,`password`,`user_type`) VALUES ('$username','$password','$user_type')";
...
<body>
    ...
    <!-- Navbar -->
    <nav class="navbar navbar-expand-md navbar fixed-top text-center">
        <div class="container">
            <a href="#">
    ...
    <div class="container justify-content-center text-center mb-3" style="margin-top: 10rem;">
        <?php
        if (isset($_GET['msg'])) {
            $msg = $_GET['msg'];
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="kamar.php" class="btn btn-primary"><i class="fa-solid fa-hand-middle-finger"></i></a>
                        </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="tipekamar.php" class="btn btn-primary"><i class="fa-solid fa-hand-middle-finger"></i></a>
                        </div>
                        <div class="card-footer">
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="fasilitashotel.php" class="btn btn-primary"><i class="fa-solid fa-hand-middle-finger"></i></a>
                        </div>
                        <div class="card-footer">
                        </div>
                    </div>
